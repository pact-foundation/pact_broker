  ...
  module Pacts
    class CreateFormattedDiff
      ...
      def self.call pact_json_content, previous_pact_json_content, raw: false
        pact_hash = JSON.load(pact_json_content, nil, PactBroker::Json::PACT_PARSING_OPTIONS)
        previous_pact_hash = JSON.load(previous_pact_json_content, nil, PactBroker::Json::PACT_PARSING_OPTIONS)
