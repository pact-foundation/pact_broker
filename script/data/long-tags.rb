...
begin
  ...
  td.delete_pacticipant("LongTagProvider")
    ...
    .publish_pact(consumer: "LogTagConsumer", provider: "LongTagProvider", consumer_version: "1", tag: "chore/update-from-oss-05d35d2873b23a093478e92eb1193a77509873f7", content_id: "2111")
    .publish_pact(consumer: "LogTagConsumer", provider: "LongTagProvider", consumer_version: "2", tag: "chore/update-from-oss-0a7a25c68c62ff297b17a4cda3b6df5b6a7927fc", content_id: "21asdfd")
