Sequel.migration do
  up do
    create_or_replace_view(:all_pacts,
      ...
      :pact_versions__revision_number, :pc__sha___pact_version_content_sha, :pact_versions__created_at).
      ...
      join(:pact_contents, {:id => :pact_version_content_id}, {:table_alias => :pc, implicit_qualifier: :pact_versions})
    )
  end
end
