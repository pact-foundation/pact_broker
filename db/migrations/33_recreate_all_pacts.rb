Sequel.migration do
  up do
    create_or_replace_view(:all_pact_publications,
      ...
      :pact_publications__revision_number, :pvc__sha___pact_version_content_sha, :pact_publications__created_at).
      ...
      join(:pact_version_contents, {:id => :pact_version_content_id}, {:table_alias => :pvc, implicit_qualifier: :pact_publications})
    )
