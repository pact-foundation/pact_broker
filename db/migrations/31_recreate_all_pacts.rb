Sequel.migration do
  up do
    create_or_replace_view(:all_pacts,
      ...
      :pact_versions__revision_number, :pvc__sha___pact_version_content_sha, :pact_versions__created_at).
      ...
      join(:pact_version_contents, {:id => :pact_version_content_id}, {:table_alias => :pvc, implicit_qualifier: :pact_versions})
    )
  end
end
