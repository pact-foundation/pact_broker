  ...
  module Webhooks
    describe Service do
      ...
      describe ".execute_webhooks" do
        ...
        before do
          allow_any_instance_of(PactBroker::Webhooks::Repository).to receive(:find_for_pact_and_event_name).and_return(webhooks)
        ...
        it "finds the webhooks" do
          expect_any_instance_of(PactBroker::Webhooks::Repository).to receive(:find_for_pact_and_event_name).with(pact, PactBroker::Webhooks::WebhookEvent::DEFAULT_EVENT_NAME)
          subject
        end
